...
{
    public partial class SetParLevels : Form
    {
        public SetParLevels()
        {
            InitializeComponent();
            ...
            else
            {
                ...
                if (blanks == 0)
                {
                    try
                    {
                        ...
                        for (int i = 0; i < productLine2DArray.GetLength(0); i++)
                        {
                            command.CommandText = "insert into BistroShelvesParRecords (ProductCode, ProductName, Cases, Units, SetParDate) " +
                                "values('" + productLine2DArray[i, 3] + "','" + productLine2DArray[i, 1] + "','" + productLine2DArray[i, 0] +
                                "','" + productLine2DArray[i, 2] + "','" + dateTimePickerPar.Value + "')";
        ...
        private void btSetParLevels_Click(object sender, EventArgs e)
        {
            setParLevels();
        }
